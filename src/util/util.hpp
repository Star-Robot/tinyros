...
#define LOG_TAG                                                                \
  std::setiosflags(std::ios::left)                                             \
      << std::setw(32) << (__Code_location__).c_str()                          \
...
template <class T> inline std::string ParamToString(T &val) {
  return std::to_string(val);
}

/// bool->str
template <> inline std::string ParamToString<bool>(bool &val) {
  return val ? "true" : "false";
}

/// const char*->str
template <> inline std::string ParamToString<const char *>(const char *&val) {
  return val;
}

/// str->str
template <> inline std::string ParamToString<std::string>(std::string &val) {
  return val;
}
...
///////////////////////// Parameter Serialization
//////////////////////////////////
template <class T> T StringToParam(std::string &val);

/// str->int
template <> inline int StringToParam<int>(std::string &val) {
  return std::stoi(val);
}

/// str->long
template <> inline long StringToParam<long>(std::string &val) {
  return std::stol(val);
}
...
/// str->long long
template <> inline long long StringToParam<long long>(std::string &val) {
  return std::stoll(val);
}

/// str->float
template <> inline float StringToParam<float>(std::string &val) {
  return std::stof(val);
}

/// str->double
template <> inline double StringToParam<double>(std::string &val) {
  return std::stod(val);
}

/// str->bool
template <> inline bool StringToParam<bool>(std::string &val) {
  return val == "true" ? true : false;
}

/// str->str
template <> inline std::string StringToParam<std::string>(std::string &val) {
  return val;
}
