...
SubscriberProxy::SubscriberProxy(std::shared_ptr<StubWrapper> core_stub,
                                 std::string node_name, std::string topic_name,
                                 int buffer_size)
    : m_core_stub_(core_stub), m_node_name_(node_name),
      m_topic_name_(topic_name), m_buffer_size_(buffer_size) {}
